...
public class OrganizationDaoImpl implements OrganizationDao {
	...
	public boolean create(Organization org) {
		...
		String sqlQuery = "INSERT INTO organization (companyName, yearOfIncorporation, postalCode, employeeCount, slogan) " +
...
//		return jdbcTemplate.update(sqlQuery, args) == 1;
	...
	public Organization getOrganization(Integer id) {
		...
		String sqlQuery = "SELECT id, companyName, yearOfIncorporation, postalCode, employeeCount, slogan " +
