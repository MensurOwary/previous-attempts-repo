...
public class DreamsController {
	...
	public String flyADream(@ModelAttribute("dream") @Valid Dream dream, final BindingResult errors,
		...
		if (errors.hasErrors()) {
			...
			return "redirect:/dream/add/";
				...
				CommonsMultipartFile file = dream.getImageFile();
				String imgLink = ds.handleFileUpload(file, session);
				dream.setImgUrl(imgLink);
				model.addAttribute("page", "dream/dream_content.jsp");
